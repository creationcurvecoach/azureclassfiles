workflow New-StorageAndVMs
{
    ...
    Write-Output "Network is: $Network"
    ...
    $StorageName = '20533lab11st' + $uniqueNumber
    $CloudsvcName1 = '20533lab11cs1' + $uniqueNumber
    $CloudsvcName2 = '20533lab11cs2' + $uniqueNumber
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUY3Mugs+c+EfXTP94sjuNLpHy
# pVygghhkMIIEwzCCA6ugAwIBAgITMwAAAIz/8uUYHhYhIgAAAAAAjDANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU/Oq6cfeVLAdX8P8CDYpN5QPwrqcwXgYKKwYB
...
# hvcNAQEBBQAEggEABY8SMs+F9TTiV902IKIdxdXfSYJUaPyHshK/ApNKfAhGFS9P
# P1TuYwoWDvhSNOO+97RRAH56f9VrsVOK8SvIMXn3NKuarsflAjR7G5RbI4+rvlSG
# AcxyosUZM9dobi1S/AHA/NBOC7hUz22ROM0rsTy0I/WGm4bLiF4oxouM3ktBqJFx
# Q6t0iLxTOvgynhlWIOxbf1svuFtfuTM+RzP5NfJ2zjV9lBHCQTXQQNjYxO2uFKNr
# CGHRvlikO6QwMtyq0VwPhffU9c4wBk8R3UlNQCcrDkgIXF7Vzgrt6r7AM/IwfvaV
# 4lXp4DkzIJ8hvcuq1Y1aWD8onHSvgrN0t6w5r6GCAigwggIkBgkqhkiG9w0BCQYx
# ggIVMIICEQIBATCBjjB3MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3Rv
# bjEQMA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0
# aW9uMSEwHwYDVQQDExhNaWNyb3NvZnQgVGltZS1TdGFtcCBQQ0ECEzMAAACM//Ll
# GB4WISIAAAAAAIwwCQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0B
# BwEwHAYJKoZIhvcNAQkFMQ8XDTE2MDMxNzAzNTMzN1owIwYJKoZIhvcNAQkEMRYE
# FNE3aMboq8VwwVpDuECuXPXgBZRIMA0GCSqGSIb3DQEBBQUABIIBAKqupb96LGTZ
# nAySql1CGELWkL0SioG58YfjT4ciBb/0ePPYmBHyYc2Rac4hUBSuWZZtHhRAp749
# 2vTMWeCnqmo685B9xLLQb40DuZ66o9D7ya7y4cpv9zfIrJnrIA5CAJu5T2oecLHn
# aTzVhbNxz65WUxCheznHfAQASliBJOhMJgToMz7Y+w97il9sHUYHPDZF0wUPeNq+
# V+EotzWMaitLR99MafqrSshAdpaIIlhuVmwforptJnlGoe4n2SQQU2KS1fqCqeqR
# gvKEEO4AA7NDIVHkXGB6dFo5ep2LBh7DLzHVJe6ghKtdWmf3dSApZFWiNlg5fT5U
# wmRMzREMT/I=
